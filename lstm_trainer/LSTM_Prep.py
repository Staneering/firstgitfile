...
class Data_Prep:
    ...
    def __init__(self, dataset):
        ...
        print('dataset is')
        print(self.dataset.head().to_string())
    ...
    def preprocess_rnn(self, date_colname, numeric_colname, pred_set_timesteps):
        ...
        print(f'rnn is {rnn_df.to_string()}')        
        # Dickey Fuller Test
...
class Predict_Future:
    ...
    def predict_future(self, X_min, X_max, numeric_colname, timesteps_to_predict, return_future = True):
        ...
        plt.show()
        print('current is')
        print(reverse_curr_frame.to_string())
        print('future is')
        print(reverse_future.to_string())
        #reverse_futformat= reverse_future['perc'].round(2)
        reverse_future['perc'].round(2).to_csv('forecasted_pop.csv',index = True)
